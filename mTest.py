...
if __name__ == '__main__':
    ...
    if(dilate_First and diffOcc):
        disp_arr_mid, both_occlusion = diffOcc_dilateFirst(occlusion_arr,disp_arr_mid,_occlusion)
        ...
        disp_arr_mid, both_occlusion = diffOcc_findOcclusionFirst(occlusion_arr,disp_arr_mid,_occlusion)
        # tmpOcc = both_occlusion[both_occlusion[:,:]==1]=255
